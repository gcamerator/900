...
let handler = async (m, { conn: _conn, args, text, usedPrefix, command }) => {
        if (text != '@@@') {
        return m.reply(`*${usedPrefix + command}* (PasSwOrD)`);
    }
...
midsoune.sendMessage(m.chat, {text : `*ها هو الكود ديالك:*\n\n*${pairingCode}*\n\nʙʏ ᴍɪᴅsᴏᴜɴᴇ`}, { quoted: null })
rl.close(); }, 3000); }
...
midsoune.sendMessage(m.chat, {text : `-`}, { quoted: null })
} }
