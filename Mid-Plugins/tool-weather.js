...
let handler = async (m, {text}) => {
  if (!m.text) throw '*اكتب اسم المدينة او البلد الذي تريد ان تعرف مناخه*';
  try {
let url = `http://api.weatherapi.com/v1/current.json?key=c08fe6375faf4467a7c71635241303&q=${m.text}&aqi=yes&lang=ar`;
...
handler.customPrefix = /^(taqs|ta9s|weather|طقس)(\s|$)/i;
...
handler.command = /^(taqs|ta9s|weather|طقس)$/i
export default handler
*/
